...
public class FilmRemove implements CommandExecutor {

    private static final String SQL_DELETE = "delete from filmTab where id = ?";

    @Override
    public int execute(String text) {
        return removeFilm(text);
    }
    ...
    @SneakyThrows
    public static int removeFilm(String text) {
